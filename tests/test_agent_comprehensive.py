...
class TestAgentPlanning:
    ...
    def test_planning_in_scope_retrieval_queries(self, real_llm_agent, retrieval_queries):
    ...
    def test_planning_settlement_calculation_queries(self, real_llm_agent, settlement_queries):
    ...
    def test_planning_bearing_capacity_calculation_queries(self, real_llm_agent, bearing_capacity_queries):
    ...
    def test_planning_out_of_scope_queries(self, real_llm_agent, out_of_scope_queries):
    ...
    def test_planning_specific_scenarios(self, real_llm_agent, question, expected_action):
        """Test specific planning scenarios with parametrized inputs"""
        plan = real_llm_agent.plan(question)
        assert plan["action"] == expected_action
    
    def test_planning_combined_queries(self, real_llm_agent):
...
class TestAgentExecution:
    ...
    def test_execution_settlement_calculation_success(self, real_llm_agent):
        ...
        result = real_llm_agent.execute(plan, "Calculate settlement")
    ...
    def test_execution_bearing_capacity_calculation_success(self, real_llm_agent):
        ...
        result = real_llm_agent.execute(plan, "Calculate bearing capacity")
    ...
    def test_execution_retrieval_success(self, real_llm_agent):
        ...
        result = real_llm_agent.execute(plan, "What is bearing capacity?")
    ...
    def test_execution_out_of_scope(self, real_llm_agent):
        ...
        result = real_llm_agent.execute(plan, "What's the weather?")
        
        assert result["action_taken"] == "out_of_scope"
        assert result["out_of_scope"] is True
        assert "scope_message" in result
    
    def test_execution_both_action(self, real_llm_agent):
        ...
        result = real_llm_agent.execute(plan, "Calculate and explain settlement")
...
class TestAgentSynthesis:
    ...
    def test_synthesis_out_of_scope_handling(self, real_llm_agent):
        ...
        answer = real_llm_agent.synthesize("What's the weather?", execution_results)
    ...
    def test_synthesis_with_calculation_results(self, real_llm_agent):
        ...
        execution_results = {
            ...
            "retrieved_info": "No information retrieved.",
            "citations": []
        }
        
        answer = real_llm_agent.synthesize("Calculate settlement", execution_results)
        
        assert len(answer) > 0
        assert answer != "I could not find a definitive answer in the knowledge base for your question."
    
    def test_synthesis_with_retrieval_results(self, real_llm_agent):
        """Test synthesis with retrieval results"""
        execution_results = {
            "action_taken": "retrieve",
            "calculation_results": "No calculations performed.",
            "retrieved_info": "Ultimate bearing capacity is calculated using Terzaghi's formula",
            "citations": [
                {"source_name": "Settle3-Theory-Manual.pdf", "confidence_score": 0.9}
            ]
        }
        
        answer = real_llm_agent.synthesize("What is bearing capacity?", execution_results)
...
class TestAgentFullWorkflow:
    ...
    def test_full_workflow_settlement_calculation(self, real_llm_agent):
        ...
        response = real_llm_agent.run(question)
    ...
    def test_full_workflow_conceptual_question(self, real_llm_agent):
    ...
    def test_full_workflow_out_of_scope_question(self, real_llm_agent):
...
class TestAgentEdgeCases:
    ...
    def test_invalid_calculation_parameters(self, real_llm_agent, invalid_params):
        ...
        result = real_llm_agent.execute(plan, "Test question")
